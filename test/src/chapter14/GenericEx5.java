...
public class GenericEx5 {
	...
	public static void main(String[] args) {
		...
		// Gen2 의 상위 클래스 제네릭 선언 가능
		Generic5<? super Gen2> g2 = new Generic5<Gen1>(g3);
		// Gen2 t1 = g2.get(); // 에러 Gen2 는 Gen2 의 부모 클래스가 아님
		// Gen3 t1 = g2.get(); // 에러 Gen3 은 Gen2 의 부모 클래스가 아님
		
		Gen1 t2 = (Gen3)g2.get(); // Gen1 은 부모 클래스이므로 가능
		Object t1 = g2.get(); // Object 는 최상위 클래스이기 때문에 가능
		
		System.out.println(t2.name);
		System.out.println(t2.getName());
		
		// Gen2 의 하위 클래스 제네릭 선언 가능
		Generic5<? extends Gen2> g4 = new Generic5<Gen3>(g3);
		Gen2 t3 = g4.get(); // Gen2 자신도 포함
		Gen3 t4 = (Gen3)g4.get(); // Gen3 은 하위 클래스이므로 가능
